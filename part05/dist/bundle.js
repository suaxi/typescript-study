...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": function() { return __WEBPACK_DEFAULT_EXPORT__; }\n/* harmony export */ });\n//食物\nclass Food {\n  constructor() {\n    //获取页面中的food元素并将其赋值给element\n    this.element = document.getElementById('food');\n  } //获取食物x轴坐标\n\n\n  get x() {\n    return this.element.offsetLeft;\n  } //获取食物y轴坐标\n\n\n  get y() {\n    return this.element.offsetTop;\n  } //食物位置随机\n\n\n  change() {\n    //食物的位置最小0，最大290，且必须是10的整数倍\n    let top = Math.round(Math.random() * 29) * 10;\n    let left = Math.round(Math.random() * 29) * 10;\n    this.element.style.left = left + 'px';\n    this.element.style.top = top + 'px';\n  }\n\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Food); // const food = new Food();\n// food.change()\n// console.log(food);\n\n//# sourceURL=webpack://part05/./src/moduls/Food.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": function() { return __WEBPACK_DEFAULT_EXPORT__; }\n/* harmony export */ });\n//积分牌\nclass ScorePanel {\n  constructor(maxLevel = 10, upScore = 10) {\n    //记录分数和等级\n    this.score = 0;\n    this.level = 1;\n    this.scoreEle = document.getElementById('score');\n    this.levelEle = document.getElementById('level');\n    this.maxLevel = maxLevel;\n    this.upScore = upScore;\n  } //加分\n\n\n  addScore() {\n    this.scoreEle.innerHTML = ++this.score + ''; //等级提升（每累计10分升级一次）\n\n    if (this.score % this.upScore === 0) {\n      this.levelUp();\n    }\n  } //升级\n\n\n  levelUp() {\n    if (this.level < this.maxLevel) {\n      this.levelEle.innerHTML = ++this.level + '';\n    }\n  }\n\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ScorePanel); // const score = new scorePanel(20, 5);\n// score.addScore()\n// for (let i = 0; i < 10; i++) {\n//     score.addScore()\n// }\n\n//# sourceURL=webpack://part05/./src/moduls/ScorePanel.ts?");
...
eval("\n\nmodule.exports = function (i) {\n  return i[1];\n};\n\n//# sourceURL=webpack://part05/./node_modules/css-loader/dist/runtime/noSourceMaps.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction insertStyleElement(options) {\n  var element = document.createElement(\"style\");\n  options.setAttributes(element, options.attributes);\n  options.insert(element, options.options);\n  return element;\n}\n\nmodule.exports = insertStyleElement;\n\n//# sourceURL=webpack://part05/./node_modules/style-loader/dist/runtime/insertStyleElement.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction setAttributesWithoutAttributes(styleElement) {\n  var nonce =  true ? __webpack_require__.nc : 0;\n\n  if (nonce) {\n    styleElement.setAttribute(\"nonce\", nonce);\n  }\n}\n\nmodule.exports = setAttributesWithoutAttributes;\n\n//# sourceURL=webpack://part05/./node_modules/style-loader/dist/runtime/setAttributesWithoutAttributes.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction styleTagTransform(css, styleElement) {\n  if (styleElement.styleSheet) {\n    styleElement.styleSheet.cssText = css;\n  } else {\n    while (styleElement.firstChild) {\n      styleElement.removeChild(styleElement.firstChild);\n    }\n\n    styleElement.appendChild(document.createTextNode(css));\n  }\n}\n\nmodule.exports = styleTagTransform;\n\n//# sourceURL=webpack://part05/./node_modules/style-loader/dist/runtime/styleTagTransform.js?");
